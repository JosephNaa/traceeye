...
public class MainActivity extends AppCompatActivity implements AbstractRenderView.ViewCallback,
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.view1Btn:
                ...
                setContentView(mStageManager.getStage(StageManager.STAGE1));
                break;
            case R.id.view2Btn:
                Log.d(TAG, "click animation");
                setContentView(mStageManager.getStage(StageManager.STAGE2));
                break;
            case R.id.view3Btn:
                Log.d(TAG, "click animation");
                setContentView(mStageManager.getStage(StageManager.STAGE3));
                break;
            case R.id.view4Btn:
                Log.d(TAG, "click animation");
                setContentView(mStageManager.getStage(StageManager.STAGE4));
                break;
    ...
    public void showReportView() {
        setContentView(mStageManager.getStage(StageManager.STAGE_REPORT));
    }
