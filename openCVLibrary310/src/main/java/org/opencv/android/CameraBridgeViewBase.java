...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public abstract void setDisplayOrientation(int result);
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if (mScale != 0) {
//                    canvas.drawBitmap(mCacheBitmap, new Rect(0,0,1920,1080), new Rect(0, 47, 2392, 1392), null);
//                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight()), //현재의 이 크기를 아래와 같이 변경
...
//        }
    ...
    private Matrix rotateMe(Canvas canvas, Bitmap bm) {
        ...
        float scale = (float) canvas.getWidth() / (float) bm.getHeight(); //1.718390804597701
